          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-5">
            {employees.map((employee) => (
              <div
                ...
                className="relative flex flex-col justify-between p-4 rounded-md bg-cream shadow-sm w-[310px]"
              >
            ...
            <div className="bg-white p-5 rounded-lg w-72">
              ...
              <div>
                <input
                  ...
                  className="mb-2.5 p-2 w-full text-black border border-black rounded"
                />
                <input
                  type="text"
                ...
                <div className="flex items-center mb-2.5">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor:
                        newEmployee.status === "Active" ? "#48bb78" : "#a0aec0", // green-500 for active, gray-400 for inactive
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-5 rounded-lg w-72">
              <div className="flex justify-center items-center">
                <h2 className="text-black text-base mb-4">Edit Employee</h2>
              </div>
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor:
                        employeeToEdit.status === "Active"
                          ? "#48bb78"
                          : "#a0aec0", // green-500 for active, gray-400 for inactive
                      transition: "background-color 0.3s ease-in-out",
                    }}
                  >
                    <div
